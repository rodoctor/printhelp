...
/**
 * Servlet implementation class AlteraImpressora
 */
@WebServlet("/AlteraImpressora")
public class AlteraImpressora extends HttpServlet {
    ...
    //List<Impressora>  lista = (ArrayList<Impressora>) session.getAttribute("minhaLista");   
        ...
        dao.altera(i); //chamada do metodo adiciona da clase dao
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        throws ServletException, IOException {
	        try {
	            ...
	            Logger.getLogger(AlteraImpressora.class.getName()).log(Level.SEVERE, null, ex);
	        }
    }
	/**
